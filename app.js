...
const bingoItems = [
    ...
    { title: "Boire le mathé de la paix avec Speedy (God)", emoji: "❤️" },
    ...
    { title: "Un fanfaron se retrouve à servir le buffet avec les bénévoles", emoji: "👓" },
    { title: "Réaliser une figure d'acrosport pendant la battle fanfare", emoji: "👥" },
    { title: "Aller à l'after chez François", emoji: "👤🐒" },
    { title: "Un tapage avec une banane isotherme picard", emoji: "💅" },
    { title: "«Dis moi ce que tu penses »", emoji: "🎷🎺🖇️🥁" },
    { title: "Bitume social", emoji: "🧀" },
    ...
    { title: "Le sticker Tapages et/ou Gods dans un lieu insolite", emoji: "🧐" },
    { title: "Prendre une photo avec Robert qui joue de la trompette dans la fanfare locale", emoji: "🌤️" },
    { title: "Faire le poirier dans la rivière de Marvejols", emoji: "👉🤏" },
    { title: "Trouver des gogottes", emoji: "🪳" },
    { title: "Faire un Jacques Mayol", emoji: "👯‍♂️" },
