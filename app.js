...
const bingoItems = [
    ...
    { title: "Boire le mathé de la paix avec Speedy (God)", emoji: "🧉" },
    { title: "Boire un irish dans le vestiaire", emoji: "🍀" },
    { title: "Louper son train/bus/minibus", emoji: "🚂" },
    { title: "Se faire de fausses lunettes au feutre", emoji: "🥸" },
    { title: "Faire un repas de croutard", emoji: "🐀" },
    { title: "Faire un massage cardiaque à un objet", emoji: "🫀" },
    { title: "Faire un faux duplex tv", emoji: "📺" },
    { title: "Un fanfaron se retrouve en cuisine avec les bénévoles", emoji: "🍳" },
    { title: "Un fanfaron se retrouve à servir le buffet avec les bénévoles", emoji: "🍽️" },
    { title: "Réaliser une figure d'acrosport pendant la battle fanfare", emoji: "🤸" },
    { title: "Aller à l'after chez François", emoji: "🕺" },
    { title: "Un tapage ou un god avec une banane isotherme picard", emoji: "🍌" },
    { title: "«Dis moi ce que tu penses »", emoji: "😡❤️" },
    { title: "Bitume social", emoji: "🅿️" },
    { title: "Bullshit boit dans sa flash de pastis", emoji: "🥃" },
    { title: "Richie squat au souba avec les Gods", emoji: "🐘" },
    { title: "Eliot met des chaussures fermées", emoji: "🥾" },
    { title: "Quelqu'un à des traces de paillettes de la veille parce qu'il en a trop mis", emoji: "💅🏻" },
    { title: "Le sticker Tapages et/ou Gods dans un lieu insolite", emoji: "🏷️" },
    { title: "Prendre une photo avec Robert qui joue de la trompette dans la fanfare locale", emoji: "🎺" },
    { title: "Faire le poirier dans la rivière de Marvejols", emoji: "🌊" },
    { title: "Trouver des gogottes", emoji: "🌲" },
    { title: "Faire un Jacques Mayol", emoji: "🤿" },
    { title: "Concerto de flûtes à nez", emoji: "👃🎵" }
];
